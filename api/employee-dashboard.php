...
try {
 ...
 $bookings=$pdo->query('SELECT b.id,b.status,b.start_date,b.end_date,c.name customer_name,f.car_label FROM bookings b JOIN customers c ON c.id=b.customer_id JOIN fleet f ON f.id=b.fleet_id ORDER BY b.created_at DESC LIMIT 10')->fetchAll();
